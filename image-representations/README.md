# Learning of image representations via distribution matching

This code was adapted from the solo-learn library---original Readme see below.

To recreeate the results in the paper, install the library and run the code in the `run_*.sh` files.

The evaluation scripts are in the `evals` folder.
